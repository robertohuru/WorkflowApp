...
r = requests.post("http://127.0.0.1:75/workflow/execute", data= jsonText, headers=headers)

#r = requests.post("http://130.89.221.193:75/workflow/execute", data= jsonText, headers=headers)
...
result = utils.getExecutionOrder(jsonData["workflows"][0])
print(result)
